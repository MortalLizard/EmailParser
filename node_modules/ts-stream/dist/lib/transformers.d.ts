...
export declare type BatcherOptions<T> = {
    minBatchSize?: number;
    flushTimeout?: number;
 ...
 */
export declare function batcher<T>(maxBatchSize: number, options?: BatcherOptions<T>): Transform<T, T[]>;
/**
 ...
 * @param handleError
 */
export declare function endCatcher<T>(handleError: (e: Error) => void | PromiseLike<void>): Transform<T, T>;
